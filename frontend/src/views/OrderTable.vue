...
export default {
  ...
  methods: {
    ...
    fillTable() {
      ...
      const saveButtonRenderer = params => {
        ...
        button.addEventListener('click', () => {
          ...
          axios.post('/api/jobs/setInd_Table/', formData)
          .then(response => {
              console.log(response.data);
          })
          .catch(error => {
    ...
    runGeneticOptimizer() {
      ...
      this.isLoading = true; // show loading icon
      axios
        .post('/api/jobs/run_preference_learning_optimizer/')
        .then((response) => {
          console.log(response.data);
          this.isLoading = false;
          this.fillTable();
    ...
    runDeadlineFirst() {
      ...
      this.isLoading = true; // show loading icon
      axios
        .post('/api/jobs/run_deadline_first/')
        .then((response) => {
          console.log(response.data);
          this.isLoading = false;
          this.fillTable();
    ...
    stopProcess() {
      axios
        .post('/api/jobs/stop_PL_optimizer/')
        .then((response) => {
          console.log(response.data);
          this.fillTable();
        })
    ...
    upload() {
      ...
      this.isLoading = true;
      axios.post('/api/jobs/uploadCSV/', formData)
        .then(response => {
          console.log(response.data);
          this.isLoading = false;
          window.alert(response.data.message);
